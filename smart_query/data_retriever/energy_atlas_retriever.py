...
This retriever can load a GeoDataFrame for one of the following entity types at a time:
    ...
    16. Census Block
    17. Cenuse Tract
    18. Power Station at Risk of Flooding
    19. Building at Risk of Flooding
...
Using load_nearby_census_blocks when the request tries to find all census blocks within a distance to some place.
...
[ Example 9 ]
Find all power stations at risk of flooding in Ohio at 2 PM on July 1, 2025.

You can return the following code:
    gdf = load_flooded_power_stations("2025070114", scope="39")
    title = "All power stations at risk of flooding in Ohio at 2 PM on July 1, 2025"
